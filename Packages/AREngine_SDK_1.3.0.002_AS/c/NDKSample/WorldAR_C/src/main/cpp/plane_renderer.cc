...
namespace hello_ar {
    ...
    void PlaneRenderer::Draw(const glm::mat4 &projection_mat,
                             const glm::mat4 &view_mat, const HwArSession *ar_session,
                             const HwArPlane *ar_plane, const glm::vec3 &color) {
        if (!shader_program_) {
    ...
    void PlaneRenderer::UpdateForPlane(const HwArSession *ar_session,
                                       const HwArPlane *ar_plane) {
        ...
        //LOGE("PlaneRenderer::UpdatePlane,polygon_length=%d",polygon_length);
        HwArPlane_getPolygonSize(ar_session, ar_plane, &polygon_length);
        LOGI("PlaneRenderer::UpdatePlane,polygon_length=%d", polygon_length);
        ...
        HwArPlane_getPolygon(ar_session, ar_plane,
        ...
        HwArPlane_getCenterPose(ar_session, ar_plane, scopedArPose.GetArPose());
        HwArPose_getMatrix(ar_session, scopedArPose.GetArPose(),
                           glm::value_ptr(model_mat_));
